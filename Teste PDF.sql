CREATE TABLE psopdf (code VARCHAR(80)) 


INSERT psopdf(code) SELECT 'cod_segm' + ' ' + 'dsc_segm'
INSERT psopdf(code) SELECT convert(varchar,cod_segm) + ' ' + dsc_segm FROM Segmento
